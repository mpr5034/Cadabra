                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="text-center">
                                    ...
                                    <button type="submit" class="btn btn-primary my-4">@lang('saas.sing_in')</button>
                                </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-6">
                            <a href="{{ route('password.request') }}" class="text-light">
                                <small>@lang('saas.forgot_password')</small>
                            </a>
                            <br />
                            <a href="{{ route('activation.resend') }}" class="text-light">
                                <small>@lang('saas.resend_activation_email')</small>
                            </a>
                        </div>
                        <div class="col-6 text-right">
                            <a href="{{ route('register') }}" class="text-light">
                                <small>@lang('saas.create_new_account')</small>
                            </a>
                        </div>
                    </div>
                </div>
